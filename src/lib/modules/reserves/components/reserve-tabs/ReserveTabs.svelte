...
<Tabs.Root value="basic" class="gap-5">
	<Tabs.List class="grid w-full grid-cols-1 gap-2 rounded-lg border border-slate-200 bg-white p-1.5 shadow-sm group-data-horizontal/tabs:h-14 sm:w-fit sm:min-w-48">
		<Tabs.Trigger value="basic" class="h-8 px-4 py-3 font-bold">Básicos</Tabs.Trigger>
	</Tabs.List>

	<Tabs.Content value="basic">
		<Tabs.Root value="detail" class="gap-5">
			<Tabs.List class="grid w-full grid-cols-2 gap-2 rounded-lg border border-slate-200 bg-white p-1.5 shadow-sm group-data-horizontal/tabs:h-auto sm:w-fit sm:min-w-xl sm:grid-cols-4">
