<script lang="ts">
	...
	import type { MovementTypePickerProps } from './props';

	let { onSelect, allowedTypes }: MovementTypePickerProps = $props();

	function canSelect(type: Parameters<typeof onSelect>[0]) {
