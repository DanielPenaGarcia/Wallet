...
<form method="POST" action="?/deleteBank" class="grid gap-4">
	...
	<p class="text-slate-600">El banco dejará de estar disponible para nuevas tarjetas.</p>
	<p class="rounded-md border border-amber-200 bg-amber-50 px-3 py-2 text-sm text-amber-900">No podrá eliminarse si tiene alguna tarjeta relacionada.</p>
